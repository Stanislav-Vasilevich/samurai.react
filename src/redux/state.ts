...
export const state: StateType = {
  homePage: {
    userBlock: {
      ...
      statusText: `Разработчик этого приложения`,
    ...
    posts: [
      {
        ...
        date: '20 августа в 11:48',
				title: 'Нужен код?',
        text: 'Привет! Как Вы там, по ту сторону экрана? Вот сижу я и думаю, может стоит взяться за что-то интересное, серьёзное, написать какой-нибудь большуший проект? Например "Вконтакте"? Как Вам такое?',
        photo: photoPost,
        photoAlt: 'Нужен код!',
        likesCount: 5,
      },
